                                     ...
                                     <tbody>
                                         {{-- @foreach ($students as $student) --}}
                                             <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-xs btn-primary" data-toggle="modal" href="{{ route('dashboard.academic.subjects.edit', 4) }}"
                                                                data-target="#editParentModal" style="margin-right: 2px">
                                                            <i class="fa fa-edit"></i>
                                                        </a>
                                                        
                                                        <a href="{{ route('dashboard.academic.subjects.destroy', 4) }}" class="btn btn-xs btn-danger delete-parent" style="margin-left: 2px"
                                                                data-parent-id="4">
