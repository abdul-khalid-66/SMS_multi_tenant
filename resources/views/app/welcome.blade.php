            ...
            <div class="container mx-auto px-6 py-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        @if($school->logo)
                            <img src="{{ asset('storage/'.$school->logo) }}" alt="{{ $school->name }} Logo" class="h-10">
                        @else
                ...
                <div class="flex flex-col md:flex-row items-center">
                    ...
                    <div class="md:w-1/2">
                        @if($school->hero_image)
                            <img src="{{ asset('storage/'.$school->hero_image) }}" alt="{{ $school->name }}" class="rounded-xl shadow-2xl border-8 border-white">
                        @else
                    ...
                    <div class="container mx-auto px-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div class="bg-white p-8 rounded-xl shadow-sm">
                                ...
                                <div class="flex items-center">
                                    <img class="w-12 h-12 rounded-full mr-4" src="{{ asset('storage/'.$testimonial->avatar) }}" alt="{{ $testimonial->author }}">
                                    <div>
                    ...
                    <div class="container mx-auto px-6">
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                            <div>
                                <div class="flex items-center mb-4">
                                    @if($school->logo)
                                        <img src="{{ asset('storage/'.$school->logo) }}" alt="{{ $school->name }} Logo" class="h-8">
                                    @endif
